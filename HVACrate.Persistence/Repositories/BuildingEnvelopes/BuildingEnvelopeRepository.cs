...
{
    public class BuildingEnvelopeRepository
        : BaseRepository<BuildingEnvelope>, IBuildingEnvelopeRepository
    {
        private readonly HVACrateDbContext _context;
        public BuildingEnvelopeRepository(HVACrateDbContext dbContext) : base(dbContext)
        {
            _context = dbContext;
        }
