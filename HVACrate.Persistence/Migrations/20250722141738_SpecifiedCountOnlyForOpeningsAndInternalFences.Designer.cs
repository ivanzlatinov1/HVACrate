...
namespace HVACrate.Persistence.Migrations
{
    ...
    [Migration("20250722141738_SpecifiedCountOnlyForOpeningsAndInternalFences")]
    partial class SpecifiedCountOnlyForOpeningsAndInternalFences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HVACrate.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 22, 14, 17, 38, 560, DateTimeKind.Unspecified).AddTicks(2504), new TimeSpan(0, 0, 0, 0, 0)))
                    ...
                    b.Property<DateTimeOffset>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 22, 14, 17, 38, 560, DateTimeKind.Unspecified).AddTicks(2713), new TimeSpan(0, 0, 0, 0, 0)))
