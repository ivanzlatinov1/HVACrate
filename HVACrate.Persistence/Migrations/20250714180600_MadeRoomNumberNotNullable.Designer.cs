...
namespace HVACrate.Persistence.Migrations
{
    ...
    [Migration("20250714180600_MadeRoomNumberNotNullable")]
    partial class MadeRoomNumberNotNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HVACrate.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 14, 18, 5, 59, 937, DateTimeKind.Unspecified).AddTicks(9227), new TimeSpan(0, 0, 0, 0, 0)))
                    ...
                    b.Property<DateTimeOffset>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 14, 18, 5, 59, 937, DateTimeKind.Unspecified).AddTicks(9445), new TimeSpan(0, 0, 0, 0, 0)))
