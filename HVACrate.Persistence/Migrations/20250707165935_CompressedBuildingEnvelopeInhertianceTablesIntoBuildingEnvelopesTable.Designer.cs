...
namespace HVACrate.Persistence.Migrations
{
    ...
    [Migration("20250707165935_CompressedBuildingEnvelopeInhertianceTablesIntoBuildingEnvelopesTable")]
    partial class CompressedBuildingEnvelopeInhertianceTablesIntoBuildingEnvelopesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HVACrate.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 7, 16, 59, 34, 854, DateTimeKind.Unspecified).AddTicks(4567), new TimeSpan(0, 0, 0, 0, 0)))
                    ...
                    b.Property<DateTimeOffset>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 7, 16, 59, 34, 854, DateTimeKind.Unspecified).AddTicks(4817), new TimeSpan(0, 0, 0, 0, 0)))
