...
namespace HVACrate.Persistence.Migrations
{
    ...
    [Migration("20250707113822_AddedBuildingEnvelopeTypesAndOtherProperties")]
    partial class AddedBuildingEnvelopeTypesAndOtherProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HVACrate.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 7, 11, 38, 21, 509, DateTimeKind.Unspecified).AddTicks(9871), new TimeSpan(0, 0, 0, 0, 0)))
                    ...
                    b.Property<DateTimeOffset>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 7, 7, 11, 38, 21, 510, DateTimeKind.Unspecified).AddTicks(69), new TimeSpan(0, 0, 0, 0, 0)))
